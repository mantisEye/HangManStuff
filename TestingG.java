...
public class TestingG
{
   ...
   public  static void main (String[] args)
   {
    ...
    String magic_word = null;
      ...
      // for example: magic_word = "living dead"   input = "d"  therefore..array list: {7,10}
         ...
         ArrayList<String> backage = wordSeperator(user_input);// this is the list that will hold each individual latter
   ...
   for(int current_index/*from backage*/=0; current_index< backage.size();current_index++)
      {
       //we have to reset those two variables:
       pin_point = 0;// ignore
       check_ahead= 0;// ignore
