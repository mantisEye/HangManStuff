...
public class TestingE
{
   ...
   public  static void main (String[] args)
   {
      ...
      //if the user entered "yes"
         ...
         {
            do{
               System.out.print("Enter the location of the file,or type \"back\" to return");
               ...
               if (new File(location).exists()) 
               {
                  if(new File(location).isFile())
                  {
                     ...
                     magic_word = extraSpaceFilter(RandomName(name));
         ...
         {
            magic_word = inGameWordSelector();// make him choose catgory method.
            key = 1;
         }
