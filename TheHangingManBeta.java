...
import java.io.File;
public class TheHangingManBeta
{
   ...
   public  static void main (String[] args)
   {
    ...
    //PART ZERO : come up with the magic word, whether by exterior file or defult catigories.
      ...
      do{
         System.out.println("Do you want to use exterior file? yes or no");
      ...
      //if the user entered "yes"
         ...
         {
            do{
               System.out.println("Enter the file's location, type \"help\" for info, or \"back\" to return.");
...
//the maunual on how to incorprate exterior information. 
   ...
   {
    System.out.println("How to input a file's location correctly:");
    System.out.println("Step 1: find the file you want to use.(If you downloaded this from GitHub, two sample files should be in the zip folder).");
    System.out.println("Step 2: right click on the file and go to 'Properties'.");
    System.out.println("Step 3: make sure that the 'Type of file' is a Text Document (.txt).");
    System.out.println("Step 4: copy down the 'Location'.");
    System.out.println("Step 5: Once you have the location, you must specify the file name and the file format.");
    System.out.println("        After copying the location from properties, add the followingat the end:");
    System.out.println("        \\file-name.txt (replace *file-name* with the name of your file.");
    System.out.println("\n      Example:");
    System.out.println();
   }
//**************************************************************************************************************************************************************************
...
1-fix the guid on how to enter file loction
2-"You already mades this guess".
3-revers the question "do u want to use exterior file?" into 
something like "do u want to use the default options?" so that
they most likely enter yes than no and avoid this shit.
*/