...
//*************************************************************************************************************************************************************************
 ...
 switch(catigory)
  { 
   case 1: random =(int)(Math.random()* animal.length);         magic_word = animal[random];      break;
   case 2: random =(int)(Math.random()* historical.length);     magic_word = historical[random];  break;
   case 3: random =(int)(Math.random()* movies.length);         magic_word = movies[random];      break;
   case 4: random =(int)(Math.random()* sport.length);          magic_word = sport[random];       break;
   case 5: random =(int)(Math.random()* fruit_veg.length);      magic_word = fruit_veg[random];   break;
   case 6: random =(int)(Math.random()* transportation.length); magic_word = transportation[random];break;
   case 7: random =(int)(Math.random()* places.length);         magic_word = places[random];      break;
  }
 return (extraSpaceFilter(magic_word)).toLowerCase();
 }
//*************************************************************************************************************************************************************************
   ...
   int number = -1;
    while( number == -1 )
    {
     ...
     switch(something)
     {
      ...
      case "8" : number = (int)(Math.random()*7)+1; break;//if the user chose random, then we will choose a random for him.
