...
public class TestingC
{
   ...
   public  static void main (String[] args)
   {
      ...
      String option = JOptionPane.showInputDialog(null, "Press 1 or type 'default' to start game with default word list.\nPress 2 or type 'advanced' to use external word list ");// error checking here to see if do what they are asked to do. You might want to add .ignorecase() somewhere there.
      if(option.contains("1") || option.contains("default"))//option.contains doesnt seem to work, fix this if you know how to.
      {
         /*
            we will have to add the new arraylist and shit here
            and the process of how everything is going to work out.
         */
         name.add(""); // we can make a default list using this format
      }
      else
      {
         FILENAME = JOptionPane.showInputDialog(null, "Enter the location of the file"); // error checking here to see if they put a link to the correct file
...
// display the opening for the 'story'
   public static void openingSequence ()
   {
      ...
      System.out.println(" _________________________  __________  ____________________");
